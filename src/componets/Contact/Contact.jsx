        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">ragu16102004@gmail.com</span>
              <a href="mailto:ragu16102004@gmail.com" className="contact__button">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">9629074704</span>
            </div>
          </div>
        </div>
        <div className="contact__content">
